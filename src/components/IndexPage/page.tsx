...
import MagneticFramer from '@/components/IndexPage/framer';
...
const projects = [
    {
        name: "Dyal Thak",
        handle: "dyal_thak",
        content: <div style={{position: 'absolute', zIndex: '1000'}}>
            <h1>Développement d'Applications</h1>
            <p>Chez AMK Dev, notre équipe de développement est dédiée à fournir des solutions sur mesure, fiables et performantes pour répondre aux besoins uniques de nos clients.</p>
...
export default function Home() {
    ...
    return (
        <main onMouseMove={mouseMove}>
            {projects.map( ({handle, content}, i) => {
                return <Gallery mousePosition={mousePosition} handle={handle} content={content} key={i}/>
            })}
        </main>
    )
}